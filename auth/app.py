...
instancia real del cliente (POST https://{subdominio}.contalibra.com.ar/api/auth/verify),
...
APEX_DOMAIN      = os.environ.get("APEX_DOMAIN", "contalibra.com.ar")
    ...
    <form method="post" action="/login-docs">
      ...
      <div class="domain-row">
        <input type="text" name="slug" id="slug" required autocomplete="off"
               placeholder="tu-empresa" value="{slug}">
